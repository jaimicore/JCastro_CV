...
1. Santiago-Algarra D, Souaid C, Singh H, Dao TML, Hussain S, Medina-Rivera A, Ramirez-Navarro L, **Castro-Mondragon JA**, Sadouni N, Charbonnier G, Spicuglia S. *Epromoters function as a hub to recruit key transcription factors required for the inflammatory response*. Nature Communications (2021) *In press*.
