...
data.frame(
  ...
  English = cell_spec(c("B1","B1","B1","B1"), 'latex', color = '#009acd'), 
  French = cell_spec(c("B1","B1","B1","B1"), 'latex', color = '#009acd'), 
  Norwegian = cell_spec(c("A2","A2","A2","A2"), 'latex', color = '#4cb8dc')
) |>
